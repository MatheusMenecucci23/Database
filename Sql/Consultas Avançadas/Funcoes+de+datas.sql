...
SELECT [DATA], CONCAT(DATENAME(DAY, [DATA]), ' ', DATENAME(MONTH, [DATA]), ' de ', DATENAME(YEAR, [DATA]))
FROM [NOTAS FISCAIS]


SELECT Nome, DATEDIFF(YEAR,[DATA DE NASCIMENTO], GETDATE()) FROM [dbo].[TABELA DE CLIENTES]
